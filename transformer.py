...
def construct_transformer(X_train, y_train, window_size, forecast_size, source, data_folder, normalizer, model_folder,
                          epoc, head_size=256, num_heads=4,
                          ff_dim=4, num_transformer_blocks=4,
                          mlp_units=128, dropout=0.4, mlp_dropout=0.25, optimizer_choice='adam',
                          loss='mean_squared_error', metrics='mean_absolute_error', learning_rate=0.001,
